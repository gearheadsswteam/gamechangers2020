package org.firstinspires.ftc.teamcode.test.roadrunner.opmode;
...
public class ManualFeedforwardTuner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (!isStopRequested()) {
            ...
            switch (mode) {
                case org.firstinspires.ftc.teamcode.drive.opmode.ManualFeedforwardTuner.Mode.TUNING_MODE:
                    if (gamepad1.x) {
                    ...
                    break;
                case org.firstinspires.ftc.teamcode.drive.opmode.ManualFeedforwardTuner.Mode.DRIVER_MODE:
                    if (gamepad1.a) {
                        mode = Mode.TUNING_MODE;
                        movingForwards = true;
                        activeProfile = generateProfile(movingForwards);
