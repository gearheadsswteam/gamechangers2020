...
class BlueRingCase1AutonomousOpModeRR {
    ...
    public void executeOpMode() {
        ...
        Trajectory traj2 = mecanumDriveRR.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(BlueTeamPositions.PARK_ONLY__LEFT_LANE_SHOOTING_POSITION_CASE_1)//Shooting angle was 0.65
                .build();
        ...
        Trajectory traj3 = mecanumDriveRR.trajectoryBuilder(traj2.end())
                .lineToLinearHeading(BlueTeamPositions.PARK_ONLY__LEFT_LANE_POSITION, slowConstraints)//Shooting angle was 0.65
                .build();
