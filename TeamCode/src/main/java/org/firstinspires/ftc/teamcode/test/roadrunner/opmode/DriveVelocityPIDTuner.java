...
public class DriveVelocityPIDTuner extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (!isStopRequested()) {
            ...
            switch (mode) {
                case org.firstinspires.ftc.teamcode.drive.opmode.DriveVelocityPIDTuner.Mode.TUNING_MODE:
                    if (gamepad1.x) {
                    ...
                    break;
                case org.firstinspires.ftc.teamcode.drive.opmode.DriveVelocityPIDTuner.Mode.DRIVER_MODE:
                    if (gamepad1.a) {
