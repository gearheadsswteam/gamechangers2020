...
public class GEarheadsOdometryPositionFinder implements Runnable{

    //TODO Rishi: Update this
     ...
     */
    public GEarheadsOdometryPositionFinder(DcMotor verticalEncoderLeft, DcMotor verticalEncoderRight, DcMotor horizontalEncoder, double COUNTS_PER_INCH, int threadSleepDelay){
     ...
     * @return global x coordinate
     */
    public double returnXCoordinateInInches(){ return robotGlobalXCoordinatePosition/ COUNTS_PER_INCH; }

    /**
     * Returns the robot's global y coordinate
     * @return global y coordinate
     */
    public double returnYCoordinateInInches(){ return robotGlobalYCoordinatePosition/ COUNTS_PER_INCH; }
