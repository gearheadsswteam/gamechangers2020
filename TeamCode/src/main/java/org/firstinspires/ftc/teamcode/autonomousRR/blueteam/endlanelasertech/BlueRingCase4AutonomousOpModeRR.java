package org.firstinspires.ftc.teamcode.autonomousRR.blueteam.endlanelasertech;
...
class BlueRingCase4AutonomousOpModeRR {
    ...
    BlueRingCase4AutonomousOpModeRR(MecanumDriveRR mecanumDriveRR, GearheadsMecanumRobotRR gearheadsMecanumRobotRR, LinearOpMode currOpMode) {
    ...
    public void executeOpMode() {
        ...
        Trajectory traj2 = mecanumDriveRR.trajectoryBuilder(traj1.end())
                .lineToLinearHeading(RedTeamPositions.PARK_ONLY__RIGHT_LANE_SHOOTING_POSITION_CASE_1)//Shooting angle was 0.65
                .build();
