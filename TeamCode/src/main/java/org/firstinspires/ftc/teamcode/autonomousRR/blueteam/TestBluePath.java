...
public class TestBluePath {
    ...
    public TestBluePath(MecanumDriveRR mecanumDriveRR, GearheadsMecanumRobotRR gearheadsMecanumRobotRR, LinearOpMode currOpMode) {
        ...
        this.initPos = BlueTeamPositions.SHOOTING_POS;
    }
    ...
    public void executeOpMode() {
        initPos = BlueTeamPositions.SHOOTING_POS;
        mecanumDriveRR.setPoseEstimate(initPos);

//
        Trajectory traj3 = mecanumDriveRR.trajectoryBuilder(BlueTeamPositions.SHOOTING_POS, 0)
