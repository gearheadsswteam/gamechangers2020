...
public class BlueAutonomousMode extends AbstractAutonomousOpMode {
    ...
    protected void executeOpMode() {
        ...
        if(rings == 0){
            ...
            BlueRingCase0AutonomousOpMode ringCase0AutonomousOpMode = new BlueRingCase0AutonomousOpMode();
            ringCase0AutonomousOpMode.executeOpMode();
        }else if(rings == 1){
            ///execute Rings = 1 case
            BlueRingCase1AutonomousOpMode ringCase0AutonomousOpMode = new BlueRingCase1AutonomousOpMode();
            ringCase0AutonomousOpMode.executeOpMode();
        }else if(rings == 4){
            ///execute Rings = 4 case
            BlueRingCase4AutonomousOpMode ringCase0AutonomousOpMode = new BlueRingCase4AutonomousOpMode();
            ringCase0AutonomousOpMode.executeOpMode();
        }
    }
}
